    ...
    <body>        
        ...
        <div class="container">
            <form action="ControladorBus" method="GET">
                ...
                <input type="text" name="txtmodelo" id="txtmodelo" required>
                <label for="txtdescripcion">Capacidad</label>
                <input type="text" name="txtdcapacidad" id="txtdcapacidad" required>
