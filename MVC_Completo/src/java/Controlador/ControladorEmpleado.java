...
public class ControladorEmpleado extends HttpServlet {
    ...
    clsEEmpleado Emp=new clsEEmpleado();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        else if (action.equalsIgnoreCase("agregar"))
        {
            ...
            String vcon=request.getParameter("txtcon");
            String vcar=request.getParameter("txtcar");
            Emp.setDni(vdni);
            Emp.setNombre(vnom);
            Emp.setApellido(vape);
            Emp.setContraseña(vcon);
            int cargo = Integer.parseInt(vcar);
            Emp.setCargo(cargo);
